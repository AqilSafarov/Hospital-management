...
namespace Labostic.Services.Migrations
{
    ...
    [Migration("20210831214157_adWorkProcessTinyint")]
    partial class adWorkProcessTinyint
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Labostic.Models.ExperienceToDoctor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Labostic.Models.ExperienceToDoctor", b =>
                {
                    b.HasOne("Labostic.Models.Doctor", "Doctor")
                        .WithMany("ExperienceToDoctor")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Labostic.Models.Experience", "Experience")
                        .WithMany("ExperienceToDoctor")
            ...
            modelBuilder.Entity("Labostic.Models.Doctor", b =>
                {
                    ...
                    b.Navigation("ExperienceToDoctor");
